<template>
  <div class="container">
    ...
    <div class="address-form">
      ...
      <input type="text" placeholder="Ingresa una dirección" ref="locationInput" class="input-address" />
      <div ref="mapContainer" class="map"></div>
      <button class="submit-button" @click="addNewAddress">Guardar Dirección</button>
    </div>
  </div>
</template>
